...
<div class="card shadow-sm border-0">
    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
        ...
        <a href="{{ url('/students/create') }}" class="btn btn-light btn-sm" title="Add New Student">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->mobile }}</td>
                        <td>
                            <a href="{{ url('/students/' . $item->id) }}" title="View Student" class="btn btn-info btn-sm">
                                <i class="fa fa-eye" aria-hidden="true"></i> View
                            </a>
                            <a href="{{ url('/students/' . $item->id . '/edit') }}" title="Edit Student" class="btn btn-primary btn-sm">

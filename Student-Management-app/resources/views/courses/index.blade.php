...
<div class="card shadow-sm border-0">
    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
        <h2 class="mb-0">Course Application</h2>
        <a href="{{ url('/courses/create') }}" class="btn btn-light btn-sm" title="Add New Course">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->duration }}</td>
                        <td>
                            <a href="{{ url('/courses/' . $item->id) }}" title="View Course" class="btn btn-info btn-sm">
